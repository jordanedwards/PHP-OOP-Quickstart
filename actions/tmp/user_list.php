  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <img src="images/add.png" alt="add" /> <a href="user_edit.php?id=0">Add New User</a></p>
<?php 
...
$dm = new DataManager();
			...
			$s_email = mysql_real_escape_string($_REQUEST["s_email"]);
			$s_tel = mysql_real_escape_string($_REQUEST["s_tel"]);
			$s_role = mysql_real_escape_string($_REQUEST["s_role"]);
...
<?php 
					...
					// Page set to reload (new query)		
						...
						$query = "SELECT * from user WHERE 1=1" . $query_where;
