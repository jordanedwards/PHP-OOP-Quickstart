...
<!--<link rel="stylesheet" href="/css/ui/smoothness/jquery-ui-1.10.4.custom.css">-->
...
<body>
<div data-role="page" data-theme="b" align="center" id="sql_page" style="text-align:center; width:100%">
...
<div data-role="fieldcontain" class="ui-field-contain ui-body ui-br"><label for="name" class="ui-input-text">Table Name:</label><input type="text" name="table_name" id="table_name" value="" class="ui-input-text ui-body-c ui-corner-all ui-shadow-inset"></div>
...
<input name="field_5" value="_" style="display:block; width:auto">
...
<td>
Type:<br>
<select class="column_type" name="type_1" id="type_1" style="display:block; width:auto" data-corners="false" data-theme="e">
<option>INT</option>
</select>
...
<div data-role="page" data-theme="b" align="center" id="files_page" style="text-align:center; width:100%">
<?php include('header.php'); ?>
...
<select name="selected_table" id="selected_table" onChange="updateSelected(this.value)" data-corners="false" data-theme="e">
...
<input type="button" value="Create CLASS File" onClick='$( "#class_create" ).dialog( "open" )' />
<input type="button" value="Create EDIT Page" onClick="trigger_download('action_edit_form_creator.php?selected_table=')" />
<input type="button" value="Create ACTION EDIT File" onClick="trigger_download('action_action_edit_creator.php?selected_table=')" />
<input type="button" value="Create ACTION DELETE File" onClick="trigger_download('action_action_delete_creator.php?selected_table=')" />
</div>
